...
const UpdateBoard = (props) => {
    ...
    const [text, setText] = 
        useState(EditorState.createWithContent(ContentState.createFromBlockArray(htmlToDraft(commitDetail).contentBlocks)))
    ...
    return (
        ...
        <EditorStyle>
            <div className = "title">
                <div>Title </div>
                <input placeholder="Please enter a title" value = {commitDetailTitle} onChange = {handleTitle}/>
            </div>
            <Editor
                editorState={text}
